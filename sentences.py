...
# This entire block runs only AFTER all API calls are complete. Writes all results to sentences.csv
print(f"\nWriting {len(processed_results)} results to {csv_out}...")
...
# Final summary message from our debugging steps
